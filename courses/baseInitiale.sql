...
CREATE TABLE `contenuListe` (
  ...
  CONSTRAINT `fk_listeId` FOREIGN KEY (`listeId`) REFERENCES `liste` (`listeId`),
...
INSERT INTO `contenuListe` VALUES (0,1,12,0),(0,2,10,0),(0,3,6,0),(0,4,2,0),(0,5,2,0),(0,6,9,0);
...
INSERT INTO `membre` VALUES (1,'Cyril','carnaud','ini01','04arnaud@gmail.com',1,'2014-04-20','Dupont'),(2,'Arnaud','aeloi','ini01','eloi.arnaud.13@gmail.com',2,'2014-04-18','Eloi');
...
-- Dump completed on 2014-04-18 16:42:13
