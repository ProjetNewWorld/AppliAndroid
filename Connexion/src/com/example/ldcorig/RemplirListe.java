	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		boutonAjouter.setOnClickListener(new AdapterView.OnClickListener(){
			...
			public void onClick(View v) {
				...
				((EditText)findViewById(R.id.editTextQuantite)).setText("");
				Toast.makeText(getApplicationContext(), "Produit ajout� dans la liste !",Toast.LENGTH_SHORT).show();
	...
	public void traiterDonneesRecues(String jsonResult){
		{
			try{
				...
				if(jsonMainNode!=null){//si c'est la liste des rayons
					...
					SimpleAdapter sARayon = new SimpleAdapter(this,listeDesMapsRayon,R.layout.rayon_layout,new String[] { "rayonLib" },new int[] { R.id.itemLibelleRayonProduitDsListe});
				...
				else //ce n'est pas la liste des rayons
				{
					...
					else//ce n'est pas la liste des produits non plus
					{
						...
						if(jsonMainNode!=null){//si c'est la liste de course
							...
							SimpleAdapter saListe = new SimpleAdapter(this,listeDesMapsProduitDsListe,R.layout.produit_a_acheter_layout,new String[] { "produitId","produitLib","listeQte" },new int[] { R.id.itemNumeroProduit,R.id.itemLibelleProduit,R.id.itemQuantiteAAcheter});
